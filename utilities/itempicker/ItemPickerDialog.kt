package com.hellopharmacy.utilities.itempicker
...
import com.dazzlerr.utilities.itempicker.ItemPickerListener
import com.dpizarro.uipicker.library.picker.PickerUI
import com.dpizarro.uipicker.library.picker.PickerUISettings
import com.hellopharmacy.R

public class ItemPickerDialog(mContext : Context , options: MutableList<String> ,mPosition:Int )
{
    ...
    init {
        ...
        mPickerUI.setColorTextCenter(R.color.black)
        mPickerUI.setColorTextNoCenter(R.color.mid_grey2)
        mPickerUI.setLinesColor(R.color.black)
